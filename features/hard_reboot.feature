# Created by jmittelmeier at 5/18/18
@wip
Feature: Instance Hard Reboot
  ...
  Scenario Outline: Delete instances
    ...
    Then I should see an element with xpath "//span[text()='Hard Reboot' and not(text()='Reboot')]" within 10 seconds
    Then I wait for 2 seconds
    When I press the element with xpath "//span[text()='Hard Reboot' and not(text()='Reboot')]"
