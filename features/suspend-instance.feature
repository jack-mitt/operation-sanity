...
Feature: Stop Instance
  ...
  Scenario Outline: Delete instances
    ...
    Then I should see an element with xpath "//i[@class='glyphicon glyphicon-pause']" within 10 seconds
    When I press the element with xpath "//i[@class='glyphicon glyphicon-pause']"
    Then I should see an element with xpath "//span[contains(text(), 'Yes, suspend this instance')]" within 10 seconds
    Then I wait for 2 seconds
    When I press the element with xpath "//span[contains(text(), 'Yes, suspend this instance')]"
    Then I should see an element with xpath "//span[contains(text(), 'suspended')]" within 10 seconds
