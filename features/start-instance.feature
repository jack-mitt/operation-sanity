...
Feature: Start Instance
  ...
  Scenario Outline: Delete instances
    ...
    Then I should see an element with xpath "//span[contains(text(), 'shutoff')]"
    When I press the element with xpath "//a[contains(text(), '<instance-name>')]"
    Then I should see an element with xpath "//i[@class='glyphicon glyphicon-play']" within 10 seconds
    When I press the element with xpath "//i[@class='glyphicon glyphicon-play']"
    Then I should see an element with xpath "//span[contains(text(), 'Yes, start this instance')]" within 10 seconds
    Then I wait for 2 seconds
    When I press the element with xpath "//span[contains(text(), 'Yes, start this instance')]"
