# Created by jmittelmeier at 5/8/18
  @wip
Feature: Stop Instance
  ...
  Scenario Outline: Delete instances
    ...
    Then I should see an element with xpath "//i[@class='glyphicon glyphicon-stop']" within 10 seconds
    When I press the element with xpath "//i[@class='glyphicon glyphicon-stop']"
    Then I should see an element with xpath "//span[contains(text(), 'Yes, stop this instance')]" within 10 seconds
    Then I wait for 2 seconds
    When I press the element with xpath "//span[contains(text(), 'Yes, stop this instance')]"
    Then I should see an element with xpath "//span[contains(text(), 'powering-off')]" within 10 seconds
