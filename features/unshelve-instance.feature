# Created by jmittelmeier at 5/3/18
@wip
Feature: Shelve Operations
  ...
  Scenario Outline: Delete instances
    ...
    When I press the element with xpath "//span[contains(text(), 'Unshelve')]"
    And I wait for 2 seconds
    Then I should see an element with xpath "//span[contains(text(), 'Yes, unshelve this instance')]"
    When I press the element with xpath "//span[contains(text(), 'Yes, unshelve this instance')]"
    And I scroll down 50 pixels
    Then I should see an element with xpath "//span[contains(text(), 'unshelving')]"
