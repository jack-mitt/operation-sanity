@wip
Feature: Test Instance Networking Operations
  ...
  Scenario Outline: Delete instances
    ...
    Then I do my own ping with the ip address at xpath //td[@data-label='IP Address']
    Then I ssh to the ip address at xpath //td[@data-label='IP Address'] with port 22
    ...
    Then I scroll down "900" pixels
    When I press the element with xpath "//span[contains(text(), 'Open Web Shell')]"
    And Switch to the new tab
    Then I should see an element with xpath "//div[@id='help-section']" within 10 seconds
    Then I close the current tab
    Then I should see an element with xpath "//span[contains(text(), 'Open Web Desktop')]" within 10 seconds
    When I press the element with xpath "//span[contains(text(), 'Open Web Desktop')]"
    And Switch to the new tab
    Then I should see an element with xpath "//div[@id='help-section']" within 10 seconds
    Then I close the current tab
